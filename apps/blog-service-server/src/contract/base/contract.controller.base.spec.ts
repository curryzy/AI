  ...
  test("POST /contracts", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        validityPeriod: CREATE_RESULT.validityPeriod.toISOString(),
      });
  });
      ...
      .expect([
        {
          ...
          validityPeriod: FIND_MANY_RESULT[0].validityPeriod.toISOString(),
        },
      ]);
  });
  ...
  test("GET /contracts/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        validityPeriod: FIND_ONE_RESULT.validityPeriod.toISOString(),
      });
  });
