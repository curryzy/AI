...
@InputType()
class CustomerInfoCreateNestedManyWithoutCustomerLevelsInput {
...
export { CustomerInfoCreateNestedManyWithoutCustomerLevelsInput as CustomerInfoCreateNestedManyWithoutCustomerLevelsInput };
