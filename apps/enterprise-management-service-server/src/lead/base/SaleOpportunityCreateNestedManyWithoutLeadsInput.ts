...
@InputType()
class SaleOpportunityCreateNestedManyWithoutLeadsInput {
...
export { SaleOpportunityCreateNestedManyWithoutLeadsInput as SaleOpportunityCreateNestedManyWithoutLeadsInput };
