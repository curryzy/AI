...
@InputType()
class SaleOpportunityUpdateInput {
  @ApiProperty({
    required: false,
    type: () => ContractUpdateManyWithoutSaleOpportunitiesInput,
  })
  @ValidateNested()
  @Type(() => ContractUpdateManyWithoutSaleOpportunitiesInput)
  @IsOptional()
  @Field(() => ContractUpdateManyWithoutSaleOpportunitiesInput, {
    nullable: true,
  })
...
export { SaleOpportunityUpdateInput as SaleOpportunityUpdateInput };
