...
@InputType()
class ContractUpdateManyWithoutSaleOpportunitiesInput {
...
export { ContractUpdateManyWithoutSaleOpportunitiesInput as ContractUpdateManyWithoutSaleOpportunitiesInput };
